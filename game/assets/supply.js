...
const glow=mat('signal',0x72e6d0,.3,.45);glow.emissive.copy(glow.color);glow.emissiveIntensity=1;
 add(new THREE.TorusGeometry(1.25,.12,6,20),glow,0,2,0,'ring');
 add(new THREE.OctahedronGeometry(.6),glow,0,2,0,'core');
