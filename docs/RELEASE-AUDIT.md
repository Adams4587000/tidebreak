...
| Self-contained public deployment | Published only `game/` from `63a395872acde9304ae559ccc25d13a9ec44e8d3` at https://adams4587000.github.io/tidebreak/. GitHub Actions build and deployment succeeded (run 36141563834). |
| Live phone/4G gate | Unchanged live harness PASS on the deployed source SHA: 11.2 s ready, 6.6 MB, 507 draws, 994,368 triangles, real tap/hold movement, zero errors/404s/external dependencies. Exact verdict and screenshots: `evidence/performance/live/`. All 96 publicly deployed files match the recorded source hashes. |
