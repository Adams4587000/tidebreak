...
| Entrant/team/rights declarations | Owner confirmed Adams4587000 is the sole entrant and meets the eligibility rules. Public contact is adamsleonard010@gmail.com. Explicit rights confirmation remains pending. The owner paused submission for live performance checks; no entry PR has been opened. |
| Submission | Submission fork and official-schema entry/PR drafts prepared in `submission/`, including the exact live verdict and deployed source SHA. The owner supplied the contact, then paused submission for live performance checks. Do not open the entry PR until the owner resumes submission and the remaining declaration is resolved. Deadline: 25 September, 23:59 UTC. |
...
The dock/audio/cache release and live performance recheck are documented in [PAGES-PERFORMANCE.md](PAGES-PERFORMANCE.md), with receipts under `evidence/dock-race-release/` and `evidence/pages-performance/`. Submission remains explicitly on hold.
